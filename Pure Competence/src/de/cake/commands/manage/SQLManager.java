package de.cake.commands.manage;
...
public class SQLManager {
	...
	public static void onCreate() {
		...
		LiteSQL.onUpdate("CREATE TABLE IF NOT EXISTS adminrights(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, guildid LONG, role LONG, music BOOLEAN)");
