...
public class GetPicCommand implements PrivateCommand {
	...
	public void performCommand(User u, PrivateChannel channel, Message message) {
		...
		try {
			if("bacc".equalsIgnoreCase(args[1])) {
				if(u.getId().equals("231777358116421633") || u.getId().equals("255313111391666176") || u.getId().equals("391244958323179532")) {
					int min2 = 0;
					int max2 = 5;
