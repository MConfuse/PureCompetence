...
public class VoiceListener extends ListenerAdapter {
	...
	public void onJoin(VoiceChannel joined, Member memb) {
		try {
			...
			if(joined.getName().toLowerCase().contains("➡") || joined.getName().toLowerCase().contains("temp") || joined.getName().toLowerCase().contains("temporary")) {	//Thanks to @Amejonah 1200#5697 and @Johnny#3826
